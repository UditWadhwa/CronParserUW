...
public class MonthHyphenHandlerTest {

    private MonthHyphenHandler HyphenHandler;
    private String validExpr = "0-0";
    private String validExpr1 = "5-7";
    private String expectedOp1 = "5 6 7";
    private String validExpr2 = "1-11/2";
    private String expectedOp2 = "1 3 5 7 9 11";

    @Before
    public void setup(){
        HyphenHandler = new MonthHyphenHandler();
    }
