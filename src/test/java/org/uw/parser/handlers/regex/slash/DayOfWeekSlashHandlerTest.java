...
public class DayOfWeekSlashHandlerTest {

    private DayOfWeekSlashHandler slashHandler;
    private String invalidExpr = "DEC/2";
    private String validExpr = "3/2";
    private String input1 = "3/3";
    private String expectedOutput1 = "3 6";

    private String input2 = "3/2";
    private String expectedOutput2 = "3 5 7";


    @Before
    public void setup(){
        slashHandler = new DayOfWeekSlashHandler();
    }
