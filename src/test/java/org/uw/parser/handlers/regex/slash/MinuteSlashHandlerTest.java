...
public class MinuteSlashHandlerTest {

    private MinuteSlashHandler slashHandler;
    private String validExpr = "0/0";
    private String validExpr1 = "5/10";
    private String expectedOp1 = "5 15 25 35 45 55";

    @Before
    public void setup(){
        slashHandler = new MinuteSlashHandler();
    }
