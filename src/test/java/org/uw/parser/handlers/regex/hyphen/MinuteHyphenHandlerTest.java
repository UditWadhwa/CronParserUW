...
public class MinuteHyphenHandlerTest {

    private MinuteHyphenHandler HyphenHandler;
    private String validExpr = "0-0";
    private String validExpr1 = "5-10";
    private String expectedOp1 = "5 6 7 8 9 10";
    private String validExpr2 = "5-40/8";
    private String expectedOp2 = "5 13 21 29 37";

    @Before
    public void setup(){
        HyphenHandler = new MinuteHyphenHandler();
    }
