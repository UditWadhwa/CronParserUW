...
public class DayOfMonthSlashHandlerTest {

    private DayOfMonthSlashHandler slashHandler;
    private String invalidExpr = "DEC/2";
    private String validExpr = "3/2";
    private String input1 = "3/3";
    private String expectedOutput1 = "3 6 9 12 15 18 21 24 27 30";

    private String input2 = "3/20";
    private String expectedOutput2 = "3 23";


    @Before
    public void setup(){
        slashHandler = new DayOfMonthSlashHandler();
    }
